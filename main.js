...
const translations = {
    es: {
        ...
        services_subtitle: 'Adaptamos su deseo a un paquete, desde sesiones profesionales hasta alquiler de estudio.',
        ...
        pricing_payment_note: '<strong>Aceptamos pago en CUP</strong> aplicando un descuento del 10% si paga en efectivo.',
        ...
        about_p1: 'Nuestra misión es ofrecer servicios fotográficos de calidad con tecnología y creatividad.',
    ...
    en: {
        ...
        hero_title: 'We Capture your <span>Essence</span>, Make your Dream a Reality',
        hero_subtitle: 'Accessibility, real-time result visualization and fast delivery service. Our studio is designed to give you comfort from the moment you trust us with your idea until you receive your photos.',
        ...
        portfolio_subtitle: 'Explore our collection of portraits, products, children, debutantes, weddings and events captured with passion and professionalism.',
        filter_all: 'All',
        filter_portraits: 'Portraits',
        filter_quince: '15th Birthdays',
        ...
        portfolio_item_2_title: '15th Birthdays',
        ...
        services_subtitle: 'We tailor your desire to a package, from professional sessions to studio rental.',
        service_1_title: 'Studio Sessions',
        service_1_desc: 'In our professional facilities with state-of-the-art equipment.',
        ...
        service_1_note_desc: 'Photo printing from 8x10 inches to canvas, photo-books and albums.',
        service_2_title: 'Outdoor Sessions',
        service_2_desc: 'At locations of your choice, we bring the studio with you.',
        service_2_feat_1: '4K digital photos',
        service_2_feat_2: 'Portable professional equipment',
        service_2_feat_3: 'Location advice',
        service_2_note_title: 'Optional:',
        service_2_note_desc: 'Photo printing from 8x10 inches to canvas, photo-books and albums.',
        ...
        pricing_payment_note: '<strong>We accept payments in any currency</strong> we use USD as a reference.',
        ...
        pricing_rental_subtitle: 'Equipment and available space',
        ...
        pricing_extra_3: '✓ Delivery within 30 days maximum',
        pricing_extra_4: '✓ Location advice',
        pricing_rental_extra_1: '✓ Free Wi-Fi internet',
        pricing_rental_extra_2: '✓ 24/7 guaranteed electricity',
        pricing_rental_extra_3: '✓ Technical assistance during session',
        
        // About
        about_tag: 'Meet Us',
        about_title: 'About Demos Studio',
        about_subtitle: 'We are a professional photography studio located in the heart of Vedado, Havana.',
        about_p1: 'Our mission is to offer quality photographic services with technology and creativity.',
        about_p2: 'We believe that every session should be an unforgettable experience, so we combine state-of-the-art equipment with personalized and professional service. Your satisfaction is our priority.',
        about_p3: 'From personal portraits to commercial photography, we specialize in capturing moments that tell stories. Trust us with your most important projects.',
